...
- Донаты артистам: 5% комиссия платформы идёт на поддержку сервиса.
- Подписка MYRA Pro (499₽/мес): без комиссии на донаты, приоритет в рекомендациях слушателей, расширенная аналитика аудитории, поддержка без очереди, ранний доступ к новым фичам.
- Студия — для артистов и подписчиков MYRA Pro: публикация своих треков через форму (название, жанр, текст песни, обложка).
